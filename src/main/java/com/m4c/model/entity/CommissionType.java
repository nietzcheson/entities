...
@Entity
@Table(name="M4CTIPOCOMISION")
public class CommissionType implements IDEntity{
	...
	@Column (name="TOTVENTAS")
	public Integer getTotsales() {
		return totsales;
	}
	public void setTotsales(Integer totsales) {
